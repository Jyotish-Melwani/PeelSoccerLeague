...
const WarehouseRow = (props) => {
    ...
    const deleteWarehouseCallback = async () => {
        const response = await axios.post(`http://localhost:5000/api/delete-game/${props.id}`);
    ...
    return (
        <>
            <ModalDialog
                ...
                title={`Delete ${props.warehouseName} Game?`}
                content={`Please confirm that you'd like to delete the ${props.warehouseName} from the list of Game. You won't be able to undo this action.`}
            ...
            <div className='warehouseRow'>
                <div className='warehouseRow__container warehouseRow__container--primary'>
                    <div className='warehouseRow__header-container'>
                        <p className='warehouseRow__header'>Games</p>
                    </div>
                    <div className='warehouseRow__subContainer'>
                        <Link className='warehouseRow__link' to={
                            {
                ...
                <div className='warehouseRow__container warehouseRow__container--senary'>
                    ...
                    <Link className='warehouseRow__link-edit' to={`/game/edit/${props.id}`}>
